...
/// PolicyRuleUpdate
/// </summary>
[DataContract(Name = "PolicyRuleUpdate")]
public class PolicyRuleUpdate : IValidatableObject
{
    /// <summary>
    ...
    */
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PolicyRuleUpdate" /> class.
    /// </summary>
    [JsonConstructor]
    protected PolicyRuleUpdate() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="PolicyRuleUpdate" /> class.
    /// </summary>
    ...
    /// <param name="id">Policy rule ID.</param>
    /// <param name="sources">Policy rule source group IDs.</param>
    /// <param name="sourceResource">Policy rule source resource that the rule is applied to.</param>
    /// <param name="destinations">Policy rule destination group IDs.</param>
    /// <param name="destinationResource">Policy rule destination resource that the rule is applied to.</param>
    public PolicyRuleUpdate(string name = null, string description = null, bool enabled = false, ActionEnum action = default, bool bidirectional = false, ProtocolEnum protocol = default, List<string> ports = null, List<RulePortRange> portRanges = null, Dictionary<string, List<string>> authorizedGroups = null, string id = null, List<string> sources = null, Resource sourceResource = null, List<string> destinations = null, Resource destinationResource = null)
    {
    ...
    */
    ...
    /// </summary>
    /// <value>Policy rule source group IDs</value>
    ...
    /// </summary>
    /// <value>Policy rule source resource that the rule is applied to</value>
    ...
    /// </summary>
    /// <value>Policy rule destination group IDs</value>
    ...
    /// </summary>
    /// <value>Policy rule destination resource that the rule is applied to</value>
    [JsonPropertyName("destinationResource")]
    ...
    public override string ToString()
    {
        ...
        sb.Append("class PolicyRuleUpdate {\n");
        ...
        sb.Append("  SourceResource: ").Append(SourceResource).Append("\n");
