...
public class RouteRequest : IValidatableObject
{
    /// <summary>
    ...
    public RouteRequest(string description = null, string networkId = null, bool enabled = false, string peer = null, List<string> peerGroups = null, string network = null, List<string> domains = null, int metric = 0, bool masquerade = false, List<string> groups = null, bool keepRoute = false, List<string> accessControlGroups = null, bool skipAutoApply = false)
    {
