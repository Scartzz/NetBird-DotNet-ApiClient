...
public class PolicyRule : IValidatableObject
{
    /// <summary>
    ...
    */
    ...
    public List<GroupMinimum> Sources { get; set; }
    ...
    public List<GroupMinimum> Destinations { get; set; }
