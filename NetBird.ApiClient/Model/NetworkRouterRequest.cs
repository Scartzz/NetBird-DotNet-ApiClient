...
/// </summary>
[DataContract(Name = "NetworkRouterRequest")]
public class NetworkRouterRequest : IValidatableObject
{
    /// <summary>
    /// Initializes a new instance of the <see cref="NetworkRouterRequest" /> class.
    /// </summary>
    [JsonConstructor]
    protected NetworkRouterRequest() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="NetworkRouterRequest" /> class.
    /// </summary>
    ...
    public NetworkRouterRequest(string peer = null, List<string> peerGroups = null, int metric = 0, bool masquerade = false, bool enabled = false)
    {
        this.Metric = metric;
    ...
    */
    ...
    public override string ToString()
    {
        ...
        sb.Append("class NetworkRouterRequest {\n");
