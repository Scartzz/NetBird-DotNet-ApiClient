...
/// PolicyCreate
/// </summary>
[DataContract(Name = "PolicyCreate")]
public class PolicyCreate : IValidatableObject
{
    /// <summary>
    ...
    public PolicyCreate(string name = null, string description = null, bool enabled = false, List<string> sourcePostureChecks = null, List<PolicyRuleUpdate> rules = null)
    {
