...
/// PeerBatch
/// </summary>
[DataContract(Name = "PeerBatch")]
public class PeerBatch : IValidatableObject
{
    /// <summary>
    /// Initializes a new instance of the <see cref="PeerBatch" /> class.
    /// </summary>
    [JsonConstructor]
    protected PeerBatch() { }
    /// <summary>
    ...
    public PeerBatch(string id = null, string name = null, DateTimeOffset createdAt = default, string ip = null, string connectionIp = null, bool connected = false, DateTimeOffset lastSeen = default, string os = null, string kernelVersion = null, int geonameId = 0, string varVersion = null, List<GroupMinimum> groups = null, bool sshEnabled = false, string userId = null, string hostname = null, string uiVersion = null, string dnsLabel = null, bool loginExpirationEnabled = false, bool loginExpired = false, DateTimeOffset lastLogin = default, bool inactivityExpirationEnabled = false, bool approvalRequired = false, string disapprovalReason = null, string countryCode = null, string cityName = null, string serialNumber = null, List<string> extraDnsLabels = null, bool ephemeral = false, PeerLocalFlags localFlags = null, int accessiblePeersCount = 0)
    {
        ...
        this.AccessiblePeersCount = accessiblePeersCount;
    ...
    */
    ...
    /// </summary>
    /// <value>Number of accessible peers</value>
    /*
    <example>5</example>
    */
    ...
    public override string ToString()
    {
        ...
        sb.Append("  AccessiblePeersCount: ").Append(AccessiblePeersCount).Append("\n");
        sb.Append("}\n");
        return sb.ToString();
    }
