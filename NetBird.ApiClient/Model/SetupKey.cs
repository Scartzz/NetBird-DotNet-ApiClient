...
/// SetupKey
/// </summary>
[DataContract(Name = "SetupKey")]
public class SetupKey : IValidatableObject
{
    /// <summary>
    /// Initializes a new instance of the <see cref="SetupKey" /> class.
    /// </summary>
    [JsonConstructor]
    protected SetupKey() { }
    /// <summary>
    ...
    */
    ...
    /// Setup Key as secret
    /// </summary>
    /// <value>Setup Key as secret</value>
    /*
    <example>A6160****</example>
    */
