# NetBird.ApiClient.Model.PolicyRule
...
**Id** | **string** | Policy rule ID | [optional] 
**Sources** | [**List&lt;GroupMinimum&gt;**](GroupMinimum.md) | Policy rule source group IDs | [optional] 
**SourceResource** | [**Resource**](Resource.md) | Policy rule source resource that the rule is applied to | [optional] 
**Destinations** | [**List&lt;GroupMinimum&gt;**](GroupMinimum.md) | Policy rule destination group IDs | [optional] 
